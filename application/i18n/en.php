...
define('ADMIN_DASHBORD_DELETE_CUSTOM_PAGE', 'Delete Custom Page');
define('ADMIN_DASHBORD_CREATE_CUSTOM_PAGE', 'Create Custom Page');
	define('ADMIN_DASHBORD_CREATE_CUSTOM_PAGE_POSITION', 'Position');
	define('ADMIN_DASHBORD_CREATE_CUSTOM_PAGE_URL_STUB', 'URL Stub');
	define('ADMIN_DASHBORD_CREATE_CUSTOM_PAGE_NAME', 'Name');
	//define('ADMIN_DASHBORD_CREATE_CUSTOM_PAGE_HREF', 'Href');
	define('ADMIN_DASHBORD_CREATE_CUSTOM_PAGE_STYLE', 'CSS Style');
	define('ADMIN_DASHBORD_CREATE_CUSTOM_PAGE_SUBMIT', 'Create Custom Page');
...
define('ADMIN_DASHBOR_EDIT_MEMBER_PERMISSIONS_GET_USER_DESC', 'Editing permissions for: ');
	...
	define('ADMIN_DASHBOR_EDIT_MEMBER_PERMISSIONS_ACCESS_ADMIN_DASHBORD', 'Access Admin Dashboard');
	...
	define('ADMIN_DASHBOR_EDIT_MEMBER_PERMISSIONS_LIST_EVENTS', 'List Events');
	define('ADMIN_DASHBOR_EDIT_MEMBER_PERMISSIONS_EDIT_EVENTS', 'Edit Events');
