...
define('ADMIN_DASHBORD_EDIT_MEMBER', 'Edit Member(Feature requires a user to edit)');
...
define('ADMIN_DASHBORD_EDIT_EVENT', 'Edit Event (Feature requires an event to edit)');
define('ADMIN_DASHBORD_EDIT_EVENT_ATTENDANCE', 'Edit Event Attendance (Feature requires an event to edit)');
