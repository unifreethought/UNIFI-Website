...
$first_name 	= ($_GET['first_name'] == '') ? '' : " `first_name` LIKE '%" . MySQL::clean($_GET['first_name']) . "%' AND ";
$last_name 		= ($_GET['last_name'] == '') ? '' : " `last_name` LIKE '%" . MySQL::clean($_GET['last_name']) . "%' AND ";
...
$phone 			= ($_GET['phone'] == '') ? '' : " `phone` LIKE '%" . MySQL::clean($_GET['phone']) . "%' AND ";
$texting 		= ($_GET['texting'] == '') ? '' : " `texting` = '" . MySQL::clean($_GET['texting']) . "' AND ";
$hometown 		= ($_GET['hometown'] == '') ? '' : " `hometown` LIKE '%" . MySQL::clean($_GET['hometown']) . "%' AND ";
$address 		= ($_GET['address'] == '') ? '' : " `address` LIKE '%" . MySQL::clean($_GET['address']) . "%' AND ";
$email 			= ($_GET['email'] == '') ? '' : " `email` LIKE '%" . MySQL::clean($_GET['email']) . "%' AND ";
